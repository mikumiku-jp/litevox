...
static size_t findSchemaMatchingBrace(const std::string &jsonText, size_t openPosition) {
    bool isString = false;
...
static size_t findSchemaMatchingBracket(const std::string &jsonText, size_t openPosition) {
    bool isString = false;
    bool isEscaped = false;
    int depth = 0;
    for (size_t position = openPosition; position < jsonText.size(); position++) {
...
static size_t findOperationResponsesOpenPosition(const std::string &jsonText, const std::string &pathText, const std::string &methodText) {
...
static size_t findOperationOpenPosition(const std::string &jsonText, const std::string &pathText, const std::string &methodText) {
    size_t pathPosition = jsonText.find("    \"" + pathText + "\": {");
    if (pathPosition == std::string::npos) {
        return std::string::npos;
    }
...
static size_t findOperationClosePosition(const std::string &jsonText, const std::string &pathText, const std::string &methodText) {
...
static void setSchemaRequestBody(std::string &jsonText, const std::string &pathText, const std::string &methodText, const std::string &requestBodyText) {
    size_t operationOpenPosition = findOperationOpenPosition(jsonText, pathText, methodText);
...
static void setSchemaParameters(std::string &jsonText, const std::string &pathText, const std::string &methodText, const std::string &parametersText) {
    size_t operationOpenPosition = findOperationOpenPosition(jsonText, pathText, methodText);
    size_t operationClosePosition = findOperationClosePosition(jsonText, pathText, methodText);
    if (operationOpenPosition == std::string::npos || operationClosePosition == std::string::npos) {
        return;
...
static void addSchemaResponseStatus(std::string &jsonText, const std::string &pathText, const std::string &methodText, const std::string &statusCode, const std::string &descriptionText) {
...
static void removeSchemaResponseStatus(std::string &jsonText, const std::string &pathText, const std::string &methodText, const std::string &statusCode) {
    size_t responsesOpenPosition = findOperationResponsesOpenPosition(jsonText, pathText, methodText);
    if (responsesOpenPosition == std::string::npos) {
        return;
    }
...
static void setSchemaResponseStatus(std::string &jsonText, const std::string &pathText, const std::string &methodText, const std::string &statusCode, const std::string &responseText) {
